...
import { FaHome, FaBoxOpen, FaHistory, FaUser, FaSignOutAlt, FaBell, FaUndo, FaUserPlus } from 'react-icons/fa';
...
const Layout = () => {
  ...
  const navItems = [
    ...
    { name: 'List Request', icon: <HiClipboardDocument />, path: '/request', roles: ['ADMIN', 'SUPER ADMIN'] },
    { name: 'Tersedia', icon: <RiAlignItemBottomLine />, path: '/tersedia', roles: ['USER', 'ADMIN', 'SUPER ADMIN'] },
